...
routes.get('/review/comment/add', ReviewController.addComment)
routes.get('/review/comment/edit', ReviewController.editComment)
routes.get('/review/comment/remove', ReviewController.removeComment)
